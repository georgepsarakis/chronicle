...
class CronInterval:
    def __init__(self, expression: str, base_time: float):
        # TODO: add validation
    ...
    def is_pending(self, current_time: float):
        return self.iterator.get_current() <= current_time

    @property
    def next_run_at(self):
        return self._next_run_at or self.iterator.get_current()
